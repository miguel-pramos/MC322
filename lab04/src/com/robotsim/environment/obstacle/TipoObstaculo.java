...
/**
 * O enum TipoObstaculo define os diferentes tipos de obstáculos que podem
 * existir no ambiente.
 * Cada tipo de obstáculo possui dimensões específicas (largura, comprimento e
 * altura) e um valor de dano.
 *
 * <p>
 * Este enum é utilizado para representar obstáculos como arame farpado, minas
 * terrestres, bunkers, sobrados e prédios.
 */
public enum TipoObstaculo {
    ...
    bunker(7, 5, 30, 0, 'B'), // Obstáculo médio que não causa dano.
    sobrado(11, 7, 45, 0, 'S'), // Obstáculo grande que não causa dano.
    predio(15, 11, 160, 0, 'P'); // Obstáculo muito grande que não causa dano.
    ...
    private final char representacao; // Representação visual do obstáculo
     ...
     * @param representacao Caractere de representação do obstáculo.
     */
