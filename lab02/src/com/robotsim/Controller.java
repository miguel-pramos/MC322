...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        int deltaX = Integer.parseInt(
                System.console().readLine("Digite o quanto " + robson.getNome() + " deve se mover no eixo X: "));
        int deltaY = Integer.parseInt(
                System.console().readLine("Digite o quanto " + robson.getNome() + " deve se mover no eixo Y: "));
